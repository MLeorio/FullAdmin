        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Liste des objets retrouv&eacute;s</h3>
                    <p class="text-subtitle text-muted">Ces annonces sont en attente de validation et publication.</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Objet retrouv&eacute;s</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($data as $notice)
                                    <tr>
                                        ...
                                        <td>
                                            <span><a href="{{ route('info', ['annonce' => $notice['id']]) }}">Modifer</a></span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
